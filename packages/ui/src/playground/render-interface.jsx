        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    description="Disclaimer that Sailfish-Studio is not connected to Scratch"
            ...
            <div className={styles.footerColumns}>
                ...
                <div className={styles.footerSection}>
                    <a href="https://desktop.sailfish-studio.org/">
                        {/* Do not translate */}
                ...
                <div className={styles.footerSection}>
                    ...
                    <a href="https://github.com/Sailfish-Studio/">
                        <FormattedMessage
                            ...
                            <div className={styles.section}>
                                <p>
                                    <FormattedMessage
                                        ...
                                        description="Description of Sailfish-Studio on the homepage"
