...
const isAlwaysTrustedForFetching = parsed => (
    ...
    // Any Sailfish-Studio service such as trampoline
    parsed.origin === 'https://sailfish-studio.org' ||
    parsed.origin.endsWith('.sailfish-studio.org') ||
    parsed.origin.endsWith('.sailfish-studio.xyz') ||
