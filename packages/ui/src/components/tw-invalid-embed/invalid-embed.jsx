...
const InvalidEmbed = () => (
    <div className={styles.container}>
        ...
        <p className={styles.code}>
            {'https://sailfish-studio.org/<project ID>/embed'}
        </p>
        <p>
            {'Here\'s an example of a full iframe to embed a project:'}
        </p>
        <p className={styles.code}>
            {`<iframe src="https://sailfish-studio.org/60917032/embed" width="482" height="412" allowtransparency="true" frameborder="0" scrolling="no" allowfullscreen></iframe>`}
        </p>
        <p>
