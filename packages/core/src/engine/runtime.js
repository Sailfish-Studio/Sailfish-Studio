...
class Runtime extends EventEmitter {
    constructor () {
         ...
         * This mode is used by the Sailfish-Studio Packager.
         */
         ...
         * Requires Sailfish-Studio/scratch-render.
    ...
    /**
     * @deprecated Used by old versions of Sailfish-Studio. Superceded by upstream's quit()
     */
    stop () {
        this.quit();
    }
